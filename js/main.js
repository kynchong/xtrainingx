...
function titleScreen() {
	...
	ctx.drawImage(titleImage, width * (1 / 3), height * (1 / 3), width * (1 / 3), width * (1 / 3))
	// ENTER to start
	ctx.font = width * (1 / 20) + "px RacingSansOne"
	ctx.fillText("Press ENTER or TAP SCREEN to start.", width / 2, height * (4 / 5))
	// Instructions
	ctx.beginPath()
...
function scoreScreen() {
	...
	ctx.fillText("Press ENTER or TAP SCREEN to Try Again!", width / 2, height * (3 / 4))
	ctx.restore()
